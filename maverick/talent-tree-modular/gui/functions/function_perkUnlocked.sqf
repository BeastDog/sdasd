...
try {
	...
	_ctrlStrucText ctrlSetStructuredText parseText format ["<t size='1' align='center' shadow='2'><t color='#A2FD5A' size='2.3'>%1</t><br /><t color='#FFFFFF'>unlocked</t></t>", _displayName];
} catch {
