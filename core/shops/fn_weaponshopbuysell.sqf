	...
	deleteMarker "DeliveryPoint";
		...
		//Check side
		 if (playerside != civilian) then {
			 ...
			 if(_price >  bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe) exitWith {hint localize "STR_NOTF_NotEnoughMoney";};
			...
			//Civilians are taxed.
			if(_pricewithtax >  bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe) exitWith {hint localize "STR_NOTF_NotEnoughMoney"; uiSleep 2;  hint format["The price of the item with tax on top is $%1.",_pricewithtax];};
			 [_item,true] spawn life_fnc_handleItem;
			 hint parseText format[localize "STR_Shop_Weapon_BoughtItem",_itemInfo select 1,[_pricewithtax] call life_fnc_numberText];
			 bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe =  bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe - _pricewithtax; 
			 uiSleep 3;
