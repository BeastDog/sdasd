...
if(bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe] call life_fnc_numberText];};
...
//////////////////////////
_perk = [life_currentExpPerks, "Perk5_2"] call mav_ttm_fnc_hasPerk; //check to see if the player has the cheap vehicle perk?
if (_perk) then { 
_ten = _basePrice/10;
_basePrice = _basePrice - _ten;
};
bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe = bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe - _basePrice;
