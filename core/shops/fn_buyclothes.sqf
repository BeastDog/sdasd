...
if(_price > bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe) exitWith {titleText[localize "STR_Shop_NotEnoughClothes","PLAIN"];};
...
if (isNil {tax getVariable "taxrate"}) then { tax setVariable ["taxrate", 5, true];;diag_log "Set 5% taxation.. Wasn't setup yet."; };
		...
		//Check side
		 if (playerside != civilian) then {
			...
			//Civilians are taxed.
			 if(_pricewithtax >  bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe) exitWith {
