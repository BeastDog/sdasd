...
if(dialog) exitWith {DisableUserInput false;};
if(_shop == "") exitWith {DisableUserInput false;};
if(_sideCheck != sideUnknown && {playerSide != _sideCheck}) exitWith {DisableUserInput false; hint localize "STR_Shop_Veh_NotAllowed"};
