...
life_intox = 0.00;
bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe = 0;//oc
...
switch (playerSide) do
{
	case west:
	{
		thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = 7500; //Starting Bank Money
	...
	case independent: {
		thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = 7500;
		life_paycheck = 400;
	};
	case east:
	{
...
[
	 //new
	 ["license_civ_red","civ"],
	 ["license_civ_kirby","civ"],
	 ["license_civ_fox","civ"],
	 //End
	 ["license_civ_phoenix","civ"],
	 ["license_civ_hughes","civ"],
	 ["license_civ_razors","civ"],
	 ["license_civ_bombsquad","civ"],
	 ["license_civ_supreme","civ"],
	 ["license_civ_marine","civ"],
	 ["license_civ_invictus","civ"],
	 ["license_civ_rpd","civ"],
	 ["license_civ_firm","civ"],
	 ["license_civ_accardo","civ"],
	 ["license_civ_fortunate","civ"],
	 ["license_civ_mafia","civ"],
	 ["license_civ_wtc","civ"],
	 ["license_civ_generations","civ"],
	 ///
	 ["license_civ_lee","civ"],
	 ["license_civ_azala","civ"],
	 ["license_civ_nightrangers","civ"],
	 ["license_civ_trust","civ"],
	 ["license_civ_olympus","civ"],
	 /////
	 ["license_civ_devgru","civ"],
	 ["license_civ_soprano","civ"],
	["license_civ_gwapo","civ"],
	 ["license_civ_valley","civ"],
	["license_civ_rouges","civ"],
	 ["license_civ_tf141","civ"],
	 ["license_civ_nsa","civ"],
	 ////
	["license_civ_mortem","civ"],
	["license_civ_appleton","civ"],
	////
	["license_civ_mag","civ"],
	["license_civ_vpd","civ"],
	["license_civ_tar","civ"],
	//
	["license_civ_whitewater","civ"],
	["license_civ_laf","civ"],
	["license_civ_stark","civ"],
	["license_civ_academi","civ"],
	//New Cobra
	...
	["license_civ_homeland","civ"],
	["license_civ_spartan","civ"],
	["license_civ_house","civ"],
	["license_civ_shadow","civ"],
	["license_civ_aces","civ"],
	//ALL BELOW ARE NEW
	["license_civ_fbi","civ"],
	["license_civ_mandigo","civ"],
	["license_civ_division","civ"],
	["license_civ_swift","civ"],
	["license_civ_syndicate","civ"],
	////
	["license_civ_triads","civ"],
	["license_civ_woodlands","civ"],
	["license_civ_desert","civ"],
	["license_civ_nightstalker","civ"],
	["license_civ_brotherhood","civ"],
	["license_civ_brotherhoodnew","civ"],
	["license_civ_harambe","civ"],
	["license_civ_pmc","civ"],
	["license_civ_lpm","civ"]
	];
