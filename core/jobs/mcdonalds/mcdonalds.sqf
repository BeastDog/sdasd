...
uiSleep 4;
hintSilent parseText format["<t size='1.25' color='#ff0000'>Your belongings have been stored in your locker, to get them back you need to sign off (WINDOWS KEY)</t>"];
cobra_waitleave = 0;
_count = 8;
...
paycheckzwdqdwqdqwdqwgegrihorghrgwdwdwddwqdwdwefgwuohweijohwefweijwefijofewijo = paycheckzwdqdwqdqwdqwgegrihorghrgwdwdwddwqdwdwefgwuohweijohwefweijwefijofewijo + 4;
