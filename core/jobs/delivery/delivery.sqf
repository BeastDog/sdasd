...
if (player distance (getMarkerPos _point) < 15) then {
	...
	thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei + _price;
