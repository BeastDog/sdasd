...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "money": {"bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe"};
	...
	case 1:
	{
		...
		case "life_inv_hackingtool": {"hackingtool"};	
		...
		case "life_inv_condom": {"condom"};
			...
			case "bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe": {"money"};
