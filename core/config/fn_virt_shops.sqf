...
switch (_shop) do
{
	...
	case "market": {["Market",["weddingring","medkit","condom","cleankit","bandage","coffee","bec","water","apple","redgull","tbacon","lockpick","fuelF","peach","boltcutter","tierope","storagesmall"]]};
	case "rebel": {["Rebel Market",["tierope","bandage","medkit","coffee","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","blastingcharge","hackingtool"]]};
	...
	case "heroin": {["Drug Dealer",["marijuana","heroinp"]]};
	case "donator": {["Donator Shop",["storagebig"]]};
	case "farmingmarket": {["Seed Market",["cannabis seed","opium seed","cannabis"]]};	
