...
switch (_vehicle) do
{
	...
	case "B_Heli_Light_01_F":
	{
		switch (_index) do
		{
			...
			case 15: {_color = "Special Weapons & Tactics"};
		};
	};
case "B_Heli_Transport_01_F":
	{
		switch (_index) do
		{
			case 0: {_color = "Lannisters"};
			case 1: {_color = "Corleones"};
			case 2: {_color = "Police"};
			case 3: {_color = "Black"};
			case 4: {_color = "Spartan Vanguard"};
			case 5: {_color = "SWAT"};
			case 6: {_color = "Redwood Rangers"};
		};
	};
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		switch (_index) do
		{
			...
			case 4: {_color = "EMS"};
			case 5: {_color = "Olympus Guardians"};
		};
	};
	case "B_MRAP_01_F":
	{
	...
	case "I_Heli_light_03_unarmed_F":
	{
		...
		{
			case 0: {_color = "Police"};
			case 1: {_color = "Faceless Ones"};
			case 2: {_color = "Supernova"};
			case 3: {_color = "VPD"};
		};
	};
};
