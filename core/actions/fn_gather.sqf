...
_resourceZones = ["wheat_1","wheat_2","sunflower_1","sunflower_2","corn_1","bean_1","cotton_1","olive_1","opium_1","cannabis_1","cannabis_2","pumpkin_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["cannabis_2"]): {_gather = "cannabis Plant"; _seeds = "cannabis seed"; _val = 1;};
...
if(!([false,_seeds,1] call life_fnc_alrphandleinventory)) exitWith {
life_action_inUse = false;
};
...
if(([true,_gather,_diff] call life_fnc_alrphandleinventory)) then
{
