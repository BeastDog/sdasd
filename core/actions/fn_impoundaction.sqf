	...
	if(!alive player) exitWith {closeDialog 0; life_action_inUse = false; koil_antispam = 0;};
		...
		waitUntil {!life_impound_inuse};
              if (_vehicle in life_vehicles) then {
                ...
                bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe = bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe + _newprice;
