...
if ( side _nearestPlayer == west && side player == civilian ) then {
	...
	while{true} do {
		...
		if(_cm == 300) then {
		_cm = 1;
			bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe = bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe + 4000;	
