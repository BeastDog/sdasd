...
_houseCfg = [(typeOf cursorObject)] call life_fnc_houseConfig;
...
if(!(_curTarget in life_vehicles) OR isNil {_curTarget getVariable "house_owner"}) then {
	...
	if((typeOf _curTarget) in ["Land_i_Garage_V1_F","Land_i_Garage_V2_F"]) then {
		...
		_Btn4 buttonSetAction "[life_pInact_curTarget] call life_fnc_givekey2; closeDialog 0;";
		_Btn4 ctrlShow true;

		_Btn5 ctrlSetText "Give Key 3";
		_Btn5 buttonSetAction "[life_pInact_curTarget] call life_fnc_givekey3; closeDialog 0;";
		_Btn5 ctrlShow true;

		_Btn6 ctrlSetText "Give Key 4";
		_Btn6 buttonSetAction "[life_pInact_curTarget] call life_fnc_givekey4; closeDialog 0;";
		_Btn6 ctrlShow true;

		_Btn7 ctrlSetText "Give Key 5";
		_Btn7 buttonSetAction "[life_pInact_curTarget] call life_fnc_givekey5; closeDialog 0;";
		_Btn7 ctrlShow true;
		...
		_Btn3 buttonSetAction "[life_pInact_curTarget] call life_fnc_givekey1; closeDialog 0;";
		_Btn3 ctrlShow true;
