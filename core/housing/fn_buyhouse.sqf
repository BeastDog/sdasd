...
if(thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei < _cost) exitWith { hint format ["You need (%1 Million Dollars) to buy this.", _costs]; closeDialog 0; };
...
if(_action) then {
	...
	thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei - (_houseCfg select 0);
