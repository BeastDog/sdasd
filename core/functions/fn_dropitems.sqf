	...
	switch(_item) do
	{
			...
			case "life_inv_keycard":
			{
				if(_value > 0) then
				{
				    ...
				    if (_copamount < 17) then {deleteVehicle _obj;};
				};
			};
		...
		case "bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe":
		{
			if(bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe > 0) then
			{
				...
				[[_obj],"life_fnc_simDisable",nil,true] spawn life_fnc_MP;
				missionNamespace setVariable[_x,0];
				if (bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe > 10000) then { deleteVehicle _obj; };
			};
		};
...
} foreach (life_inv_items + ["bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe"]);
