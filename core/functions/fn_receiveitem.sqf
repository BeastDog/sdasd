...
{
	if(([true,_item,_diff] call life_fnc_alrphandleinventory)) then
	{
...
{
	if(([true,_item,(parseNumber _val)] call life_fnc_alrphandleinventory)) then
	{
		private["_type"];
...
if(_item == "weddingring" && life_married != "-2") then
{
