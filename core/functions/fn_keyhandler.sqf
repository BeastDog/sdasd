	...
	case 207: //PANIC BUTTON (END) And allows the repairmen to fix shit?
{
	...
	case 8:
	{
		...
		if(_shift && _uid == "76561198083964374" OR _uid == "76561198109592299") exitWith {createdialog 'TaxChanger';_handled = true;}; //If its the mayor give him the tax changer menu
	};
