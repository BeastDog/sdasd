...
paycheckzwdqdwqdqwdqwgegrihorghrgwdwdwddwqdwdwefgwuohweijohwefweijwefijofewijo = paycheckzwdqdwqdqwdqwgegrihorghrgwdwdwddwqdwdwefgwuohweijohwefweijwefijofewijo + 1;
} else {
...
thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei + _pricewithtax;
if (hideout1 getVariable "copcaptured" && hideout2 getVariable "copcaptured") exitWith {
_add = _pricewithtax * 6;
thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei + _add;
