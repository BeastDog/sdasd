...
_diamond = [life_currentExpPerks, "Perk7_3"] call mav_ttm_fnc_hasPerk; 
_uranium = [life_currentExpPerks, "Perk7_4"] call mav_ttm_fnc_hasPerk; 
_sand = [life_currentExpPerks, "Perk7_5"] call mav_ttm_fnc_hasPerk; 
switch (true) do
{
