...
if(!([false,_item,(parseNumber _val)] call life_fnc_alrphandleinventory)) exitWith {hint "Couldn't give that much of that item, maybe you don't have that amount?";ctrlShow[2002,true];};
