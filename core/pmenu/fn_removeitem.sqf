...
if(!([false,_data,(parseNumber _value)] call life_fnc_alrphandleinventory)) exitWith {hint "Couldn't remove that much of that item, maybe you don't have that amount?"};
