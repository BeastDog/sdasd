...
if(parseNumber(_amount) > bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe) exitWith {hint "You don't have that much to give!";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
...
bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe = bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe - (parseNumber(_amount));
if(parseNumber(_amount) > 15000) then {
	[0] call SOCK_fnc_updatePartial;
};
[] call SOCK_fnc_updateRequest;
[[_unit,_amount,player],"life_fnc_recfqqwffqwfqwfqwfqqwfwqqfwfqfeivdwqwqwMoney",_unit,false] spawn life_fnc_MP;
