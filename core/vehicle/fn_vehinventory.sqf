...
{
	//Money Handle
	if(_x != "bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe") then
	{
		...
		else
	{
		...
		{
			_pInv lbAdd format["$%1",[bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe] call life_fnc_numberText];
