...
while {true} do {
  ...
  _text = format ["CASH: $%3 | BANK: $%4 | UPTIME: %1 | THREAT LEVEL: %2", [serverTime,"HH:MM:SS"] call BIS_fnc_secondsToString, _threat, [bradleyisacoonniggerfeiojfijwefweijoijofewiojfeiuowfeiojfewiojwefijofewjiowefijowfejiowfe] call life_fnc_numberText,[thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei] call   
    life_fnc_numberText];
