...
if(_val > thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei) exitWith {hint localize "STR_ATM_NotEnough"};
...
if((_val + _tax) > thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei) exitWith {hint format[localize "STR_ATM_SentMoneyFail",_val,_tax]};
...
thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei = thisisdefinatenlynotafuckingniggercashvariableyoucoonfejfiejfejifeijefijefiejfiejefijfjei - (_val + _tax);
