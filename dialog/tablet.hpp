...
enableSimulation = 1;
duration = 500000;
onLoad = "uiNamespace setVariable [""syncmenu"", _this select 0]; tabletmenuisopen = 1; [] spawn SOCK_fnc_syncData; closeDialog 1;";
onunload = "tabletmenuisopen = 0; closeDialog 1;";
objects[] = {};
};
