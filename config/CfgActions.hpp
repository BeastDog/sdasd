class CfgActions {
	...
	class useMenu {
		...
		items[] = {"alrp_rob","alrp_gagmarshals","alrp_blindfoldmarshals","alrp_medicleg","alrp_lootchest","alrp_lawyer","alrp_fixgenerator","alrp_medicarm","alrp_vehiclereg","alrp_gagswat","alrp_medicbrain","alrp_medicchest","alrp_capturedrug","alrp_coppat","alrp_cancelcapture","alrp_capturedrug2","alrp_cancelcapture2","alrp_leavejob","alrp_escortmedic","alrp_lockstorage","alrp_checklicenses","alrp_fingerprint","alrp_removelic","alrp_searchperson","alrp_unrestrain","alrp_sendtojail","alrp_ticket","alrp_unblindfold","alrp_lockhouse","alrp_sellhouse","alrp_raidhouse","alrp_storegarage","alrp_usegarage","alrp_sellgarage","alrp_buyhouse","alrp_destroycomms","alrp_escortciv","alrp_stopescort","alrp_escort","alrp_throwincar","alrp_throwincarciv","alrp_throwincarmed","alrp_dropbag","alrp_blindfold","alrp_blindfoldswat","alrp_gag","alrp_pickupbag","alrp_untie","alrp_tie","alrp_destroyevidence","alrp_gatherevidence","alrp_axe","alrp_mine","alrp_healhospital","alrp_patdown","alrp_patdowncop","alrp_panicbutton","alrp_healperson","alrp_houseowner","alrp_healself","alrp_devicemine","alrp_givecash","alrp_getjob","alrp_collectpaycheck","alrp_atm","alrp_atmbank","alrp_repairvehicle","alrp_impound","alrp_impoundmed","alrp_pullout","alrp_push","alrp_pushdouble","alrp_pushtriple","alrp_unflip"};
		...
		class alrp_cancelcapture2 {
			...
			class alrp_atm {
			requirement = "(cursorobject isKindOf 'Land_Atm_02_F' && player distance cursorObject < 8)";
			displayName = "Use ATM";
			lbdata = "alrp_atm"; 
		};
		...
		class alrp_dropbag {
			requirement = "(playerside != independent && cobra_attached == 1)";
			displayName = "Drop Money Bag";
			lbdata = "alrp_dropbag"; 
		};
		class alrp_healself {
		...
		class alrp_tie {
			requirement = "(playerside == civilian && player distance cursorTarget < 4 && animationState cursorTarget == 'Incapacitated' OR animationState cursorTarget == 'AmovPercMstpSsurWnonDnon')";
